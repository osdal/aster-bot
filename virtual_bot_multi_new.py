...
SYMBOLS = os.getenv("LIVE_SYMBOL", "XRPUSDT").split(",")  # если несколько символов, через запятую
...
def get_trend_and_slope(symbol):
...
# ========= MAIN =========
print("=== MULTI-VIRTUAL BOT (NEW FILE) STARTED ===")
